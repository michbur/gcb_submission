...
Scheme of extended HSMM can be seen in Fig.~\ref{fig:ngramext}.
...
The signalHsmm web-server is avaible under address: \url{http://smorfland.uni.wroc.pl/signalhsmm}.

signalHsmm is implemented as an R package freely available on CRAN: \url{http://cran.r-project.org/web/packages/signal.hsmm}.
