...
The best and the worst encoding share some similarities. In both cases Group 1 tends to contain polar 

The both groupings have strongly pronounced non-polar and highly hydrophobic group 3 (see Table~\ref{tab:best}, Table~\ref{tab:best} and Figure~\ref{fig:enccomp}) containing isoleucine, leucine, methionine and valine.
...
\caption{A comparision of encodings. A) Properties of amino acids in the best and the worst sensitivity encoding. B) Frequencies of amino acids beloning to the encodings in regions of signal peptide and mature protein.}
\label{fig:enccomp}
\end{figure}
