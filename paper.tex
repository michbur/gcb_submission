...
Scheme of extended HSMM can be seen in figure~\ref{fig:model_hsmm_kMer}.

Using the biogram software (BIOGRAM CITATION) we extracted n-grams from cleavage sites of signal peptides. 
...
\caption{Results of cross-validation. 1. An encoding providing the best sensitivity (AUC = 0.9337). 2. A group of encodings with be best sensitivity/specificity ratio (mean AUC = 0.9650). 3. An encoding providing the best specificity (AUC = 0.9686).}
\label{fig:cvres}
\end{figure}
