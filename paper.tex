...
\begin{figure}
 \begin{minipage}{.5\linewidth} 
    ...
    \label{fig:model_hsmm}
      \tikzstyle{line} = [draw=black, color=blue!30!black!50, line width=3mm, -latex']
      \tikzstyle{main node} = [circle,fill=blue!20,draw, minimum size = 2.2cm, font=\Large\itshape,
         align=center,  ] %font=\sffamily\small\bfseries,
      %nodes
      \node[main node]            (start') 	[]						{Start};	     
      \node[main node, fill=purple!80!black!40 ] 	(nregion') 	[right of=start',xshift=-5mm, yshift=15mm] 	{n-region};
      \node[main node, fill=orange!70!black!40] 	(hregion') 	[right of=nregion',xshift=-5mm,yshift=15mm] 	{h-region};
      \node[main node, fill=yellow!70!black!40] 	(cregion') 	[right of=hregion',xshift=-5mm,yshift=-15mm] 	{c-region};
      \node[main node, fill=green!70!black!40] 	(mature') 	[right of=cregion',xshift=-5mm, yshift=-15mm] 	{Mature protein};
...
\end{minipage}
 \begin{minipage}{.5\linewidth}
    ...
    \label{fig:model_hsmm_kMer}
      ...
      %nodes
      \node[main node]            (start')   []  					{Start};	     
      \node[main node, fill=purple!80!black!40] 	(nregion') 	[right of=start',xshift=-25mm, yshift=35mm] 	{n-region};
      \node[main node, fill=orange!70!black!40] 	(hregion') 	[right of=nregion',xshift=-15mm,yshift=35mm] 	{h-region};
      \node[main node, fill=yellow!70!black!40] 	(cregion') 	[right of=hregion',xshift=-10mm,yshift=-10mm] 	{c-region};
      \node[main node, fill=green!70!black!40] 	(mature') 	[below of=hregion',xshift=15mm, yshift=-110mm] 	{Mature protein};
      
      \node[main node, fill=green!50!red!60!black!20]   (kmer1) 	[below of=cregion',xshift=35mm,yshift=30mm] 	{Aminoacid 1};
      \node[main node, fill=green!50!red!60!black!20]   (kmer2) 	[below of=kmer1,xshift=-5mm,yshift=-5mm] 	{Aminoacid 2};
      \node[main node, fill=green!50!red!60!black!20]   (kmer3) 	[below of=kmer2,xshift=-5mm,yshift=-5mm] 	{Aminoacid 3};
      %lines
      \path [line] (start')   edge node [left, color=black] {} (nregion');
      \path [line] (nregion') edge node [below, color=black] { } (hregion');
      \path [line] (hregion') edge node [below, color=black] { } (cregion');
...
\begin{figure}[ht]\centering
\includegraphics[width=0.95\textwidth]{figures/cvres.eps}
